...
-- Correct Pasting
vim.keymap.set({ "n", "v" }, "<leader>p", '<CMD> set paste<CR>"+p<CMD>set paste!<CR>', { noremap = true })
vim.keymap.set({ "n", "v" }, "<leader>P", '<CMD> set paste<CR>"+P<CMD>set paste!<CR>', { noremap = true })
...
-- LSP {{{
vim.api.nvim_set_keymap("n", "K", "<cmd>lua vim.lsp.buf.hover()<CR>", { noremap = true }) -- Hover object
vim.api.nvim_set_keymap("n", "ga", "<cmd>lua vim.lsp.buf.code_action()<CR>", { noremap = true }) -- Code actions
vim.api.nvim_set_keymap("n", "gR", "<cmd>lua vim.lsp.buf.rename()<CR>", { noremap = true }) -- Rename an object
...
-- 	{ noremap = true }
-- ) -- Goto declaration
vim.api.nvim_set_keymap("n", "<leader>fr", "<cmd>Telescope oldfiles<CR>", { noremap = true }) -- Show recent files
vim.api.nvim_set_keymap("n", "<leader>fj", "<cmd>Telescope git_files<CR>", { noremap = true }) -- Search for a file in project
vim.api.nvim_set_keymap("n", "<leader>ff", "<cmd>Telescope find_files<CR>", { noremap = true }) -- Search for a file (ignoring dotfiles)
vim.api.nvim_set_keymap(
	"n",
	"<leader>fa",
...
-- 	{ noremap = true }
-- ) -- Show git branches
vim.api.nvim_set_keymap("n", "<leader>fg", "<cmd>Telescope live_grep<CR>", { noremap = true }) -- Find a string in project
vim.api.nvim_set_keymap("n", "<leader>fb", "<cmd>Telescope buffers<CR>", { noremap = true }) -- Show all buffers
vim.api.nvim_set_keymap("n", "<leader>f?", "<cmd>Telescope<CR>", { noremap = true }) -- Show all commands
vim.api.nvim_set_keymap("n", "<leader>fs", "<cmd>Telescope lsp_dynamic_workspace_symbols<CR>", { noremap = true }) -- Search for dynamic symbols
vim.api.nvim_set_keymap("n", "<leader>fu", "<cmd>Telescope undo<CR>", { noremap = true }) -- Show undotree
vim.api.nvim_set_keymap("n", "<leader>fn", "<cmd>Telescope notify<CR>", { noremap = true }) -- Show nvim-notify history
-- }}}

-- Neo Tree {{{
vim.api.nvim_set_keymap("n", "<leader>n", "<cmd>Neotree toggle<CR>", { noremap = true }) -- Toggle file explorer
vim.api.nvim_set_keymap("n", "<leader>e", "<cmd>Neotree focus<CR>", { noremap = true }) -- Focus file explorer
-- }}}

-- Bufferline {{{
vim.api.nvim_set_keymap("n", "<Tab>", "<cmd>BufferNext<CR>", { noremap = true }) -- Toggle file explorer
vim.api.nvim_set_keymap("n", "<S-Tab>", "<cmd>BufferPrev<CR>", { noremap = true }) -- Toggle file explorer
-- }}}

-- vim undotree
vim.api.nvim_set_keymap("n", "<leader>u", "<cmd>UndotreeToggle<CR>", { noremap = true }) -- Toggle file explorer
vim.api.nvim_set_keymap("n", "<leader>i", "<cmd>UndotreeFocus<CR>", { noremap = true }) -- Toggle file explorer
-- nm('<leader>i', '<cmd>UndotreeHide<CR>')                                        -- Toggle file explorer

-- vim-fugtive {{{
vim.api.nvim_set_keymap("n", "<leader>gg", "<cmd>Git<CR>", { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>gd", "<cmd>Git diff<CR>", { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>gc", "<cmd>Git commit<CR>", { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>ga", "<cmd>Git add<CR>", { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>gs", "<cmd>Git show<CR>", { noremap = true })
